...
export function setStoneNumber(number: number): void {
...
export function setWoodNumber(number: number): void {
...
export function setCoinNumber(number: number): void {
...
export function setFireNumber(number: number): void {
...
export function setWaterNumber(number: number): void {
...
export function setTrashNumber(number: number): void {
...
export function setFishNumber(number: number): void {
...
export function setBushNumber(number: number): void {
...
export function setJollyNumber(number: number): void {
